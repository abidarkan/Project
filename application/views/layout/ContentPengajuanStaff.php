            ...
            <div class="card-body">
                <div class="mb-3">
                    <a href="<?= site_url('Staff/pengajuan?statusFilter=') ?>"
                        class="btn btn-primary <?= !isset($_GET['statusFilter']) ? 'active' : '' ?>">All</a>
                    <a href="<?= site_url('Staff/pengajuan?statusFilter=DIAJUKAN') ?>"
                        class="btn btn-primary <?= isset($_GET['statusFilter']) && $_GET['statusFilter'] == 'DIAJUKAN' ? 'active' : '' ?>">In
                        Progress</a>
                    <a href="<?= site_url('Staff/pengajuan?statusFilter=SEDANG DIREVIEW') ?>"
                        class="btn btn-primary <?= isset($_GET['statusFilter']) && $_GET['statusFilter'] == 'SEDANG DIREVIEW' ? 'active' : '' ?>">Edited</a>
                    <a href="<?= site_url('Staff/pengajuan?statusFilter=DITERIMA') ?>"
                        class="btn btn-primary <?= isset($_GET['statusFilter']) && $_GET['statusFilter'] == 'DITERIMA' ? 'active' : '' ?>">Completed</a>
                    <a href="<?= site_url('Staff/pengajuan?statusFilter=DITOLAK') ?>"
                        class="btn btn-primary <?= isset($_GET['statusFilter']) && $_GET['statusFilter'] == 'DITOLAK' ? 'active' : '' ?>">Rejected</a>
                </div>
